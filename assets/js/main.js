...
(function ($) {
  ...
  $(".tp-portfolio-active-3").slick({
    ...
    arrows: true,
    prevArrow:
      '<button type="button" class="slick-prev"><i class="fa-regular fa-arrow-left-long"></i></button>',
    nextArrow:
      '<button type="button" class="slick-next"><i class="fa-regular fa-arrow-right-long"></i></button>',
    slidesToShow: 3,
    slidesToScroll: 1,
    responsive: [
      {
  ...
  function bubbles() {
    ...
    $bubbles.find(".bubble-container").each(function () {
      ...
      var size_rand =
        min_bubble_size + Math.floor(Math.random() * (max_bubble_size + 15));
